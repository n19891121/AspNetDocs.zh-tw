...
[下載代碼](iteration-4-make-the-application-loosely-coupled-vb/_static/contactmanager_4_vb1.zip)
...
**清單 1 - 型號\IContactManagerRepository.vb**
...
> [前一個](iteration-3-add-form-validation-vb.md)
> [下一個](iteration-5-create-unit-tests-vb.md)
